 ...
 */
public class ImageClassifierFloatMobilenetRetrained extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifierFloatMobilenetRetrained(Activity activity) throws IOException {
    super(activity);
