...
public class Camera2BasicFragment extends Fragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        try {
            // create either a new ImageClassifierQuantizedMobileNet or an
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Size largest =
                        Collections.max(
                                Arrays.asList(map.getOutputSizes(ImageFormat.JPEG)), new
                                        CompareSizesByArea());
                imageReader =
    ...
    private String[] getRequiredPermissions() {
        ...
        try {
            PackageInfo info =
                    activity
                            .getPackageManager()
                            .getPackageInfo(activity.getPackageName(), PackageManager
                                    .GET_PERMISSIONS);
    ...
    private void openCamera(int width, int height) {
        if (!checkedPermissions && !allPermissionsGranted()) {
            FragmentCompat.requestPermissions(this, getRequiredPermissions(),
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            previewRequestBuilder = cameraDevice.createCaptureRequest(CameraDevice
                    .TEMPLATE_PREVIEW);
